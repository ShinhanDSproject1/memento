...
<body data-mentos-id="${mentosId}"
	...
	<jsp:include page="/WEB-INF/views/mentos/joinPopup.jsp" />
	<div class="container">
		<div class="class-wrapper-frame">
			<div class="class-main-info">
				<div class="frame-429">
					<div class="hover-tag category"></div>
					<div class="hover-tag language"></div>
				</div>
					...
					<div class="class-location-info">
						<div class="mentos-class-image-frame">
							<img class="mentos-class-image"
								src="${cpath}/resources/images/mentosFull/class5.png" />
						</div>
						<div class="location-detail">
							<div class="location-row">
								<img class="icon"
									src="${cpath}/resources/images/mentosFull/maps.svg" />
						...
						<div class="class-mentor-section"
							...
							<div class="mentor-profile">
								<img class="mentor-image"
									src="${cpath}/resources/images/mentosDetail/profile.png" />
							</div>
			...
			<div id="mentosCardTemplate"
				...
				<div class="mentos-class">
					<div class="mentos-text">
						...
						<div class="aws" id="mentos-title">비전공자도 이해할 수 있는 AWS 입문/실전</div>
						<div class="frame-406">

							<div class="frame-407">
								<img class="user-user"
									src="${cpath}/resources/images/mentosFull/mento.svg" />
							...
							<div class="frame-408">
								<img class="icon-time-calendar"
									src="${cpath}/resources/images/mentosFull/day.svg" />
							...
							<div class="frame-409">
								<img class="icon-time-clock-outlined"
									src="${cpath}/resources/images/mentosFull/time.svg" />
					...
					<img class="image"
						src="${cpath}/resources/images/mentosFull/class4.png" />
					<div class="mentos-hover-popup">
						<div class="hover-inner">
							...
							<div class="hover-tags">
								<span class="hover-tag category">#AWS</span> <span
									class="hover-tag language">#클라우드</span>
							</div>
						</div>
					</div>
				</div>
