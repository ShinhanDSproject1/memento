...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/mentos/mentosMentoDetailStyle.css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/mentos/mentosMentoDetailVars.css" />
</head>
<link
	href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css"
	rel="stylesheet" />
<script
	src="${pageContext.request.contextPath}/resources/js/mentos/mentosMentoDetail.js"></script>
			...
			<div class="frame-3643">
				<div class="frame-336">
					<div class="frame-3639">
						<div
							class="sites-youtube-linked-in-career-jscode-ceo-cto-cto-daly-cto-teammate-ceo-books-do-it-jscode-aws-2025-05-etc">
							<span> <span
								class="sites-youtube-linked-in-career-jscode-ceo-cto-cto-daly-cto-teammate-ceo-books-do-it-jscode-aws-2025-05-etc-span">
									소개글 <br />
							</span> <span
								class="sites-youtube-linked-in-career-jscode-ceo-cto-cto-daly-cto-teammate-ceo-books-do-it-jscode-aws-2025-05-etc-span2">
									<br />
							</span> <span
								class="sites-youtube-linked-in-career-jscode-ceo-cto-cto-daly-cto-teammate-ceo-books-do-it-jscode-aws-2025-05-etc-span3">
									[Sites] <br /> Youtube 바로가기 (클릭!) <br /> LinkedIn 바로가기 (클릭!)
									<br />   <br /> [Career] <br /> 現) JSCODE - 대표 멘토, CEO <br />
									前) (주)트라이포드랩 - CTO <br /> 前) (주)온리원유니버스 - CTO <br />
									前) 달리(DALY) - CTO <br /> 前) 팀메이트(Teammate) - CEO <br />   <br />
									[Books] <br /> 『Do it! JSCODE의 AWS 입문』, 이지스퍼블리싱 (2025.05) <br />
									  <br /> [ETC] <br /> - 기업 대상 개발 컨설팅 및 코딩 교육 활동
							</span>
							</span>
						</div>
					</div>
				</div>
				<div class="frame-36432">
					<div class="frame-372">
						<div class="frame-340">
							<div class="frame-338">
