...
<c:set var="cpath" value="${pageContext.servletContext.contextPath}" />
	...
	<link rel="stylesheet" href="${cpath}/resources/css/mypage/spark-test/spark-test.css" />

  <section id="spark-test" class="spark-test">
      <article class="spark-test__designLavel"></article>
    <div class="spark-test__container--title" 
        style="
        background: url('${cpath}/resources/images/mypage/spark-test/img-spark-test.png')
