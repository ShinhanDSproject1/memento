...
<c:set var="cpath" value="${pageContext.servletContext.contextPath}" />
	...
	<link rel="stylesheet" href="${cpath}/resources/static/css/mypage/spark-test/spark-test.css" />

  <section id="spark-test" class="spark-test">
      <article class="spark-test__designLavel"></article>
    <div class="spark-test__container--title" 
        style="
        background: url('${cpath}/resources/static/images/mypage/spark-test/img-spark-test.png')
    ...
    <section class="spark-test__container--button">
        <button 
        		data-url="${cpath}/mypage/spark-test/spark-test-start"
        		class="spark-test__button spark-test__button--teststart page-link">
        		테스트 시작하기
        </button>
        <button 
        		data-url="${cpath}/mypage/spark-test/spark-test-type-check"
