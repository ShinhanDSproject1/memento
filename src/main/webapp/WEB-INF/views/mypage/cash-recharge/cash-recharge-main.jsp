...
<link rel="stylesheet"
	href="${cpath}/resources/css/mypage/cash-recharge/cash-recharge-main.css" />

		<div class="cash-recharge-container">
			<div class="group-200">
				<div class="me">
					<span> <span class="me-span">me</span> <span
						class="me-span2">캐시충전</span>
					</span>
				</div>
			...
			<div class="frame-423">
				<div class="group-167" onclick="changeRectangleColor(event)">
					...
					<img class="vuesax-linear-money-recive"
				...
				<div class="group-168" onclick="changeRectangleColor(event)">
					...
					<img class="vuesax-linear-money-recive2"
						src="${cashImgPath}/won.svg" />
				...
				<div class="group-169" onclick="changeRectangleColor(event)">
					...
					<img class="vuesax-linear-money-recive3"
						src="${cashImgPath}/won.svg" />
				...
				<div class="group-170" onclick="changeRectangleColor(event)">
					...
					<img class="vuesax-linear-money-recive4"
						src="${cashImgPath}/won.svg" />
				...
				<div class="group-171" onclick="changeRectangleColor(event)">
					...
					<img class="vuesax-linear-money-recive5"
						src="${cashImgPath}/won.svg" />
			...
			<div class="frame-4232">
				<div class="group-178">
					<div class="me3">
						<span> <span class="me-3-span">보유</span> <span
							class="me-3-span2">me</span> <span class="me-3-span">캐시</span>
						</span>
					</div>
					<div class="_0">0원</div>
...
<!-- 						<div class="_03">0원</div> -->
				...
				<div class="group-175">
					<div class="div-recharge-check">위 내용을 확인하였으며 결제에 대해 동의합니다.</div>
					<img class="vuesax-linear-arrow-circle-down"
						src="${cashImgPath}/check.svg" />
				</div>
				<div class="group-173">
					<div class="rectangle-226"></div>
					<div class="me8" onclick="changeButtonColor(event)">
						<span> <span class="me-8-span">me</span> <span
							class="me-8-span2">캐시 충전하기</span>
						</span>
					</div>
				</div>
			</div>
			<div class="frame-177">
				...
				<div
					...
					<span> <span
						...
						<ul
							class="me-me-mento-me-me-mento-me-me-me-7-me-7-i-os-me-080-333-4000-google-play-me-48-google-play-48-1-1-me-span2">
							<li>충전 후 한 번도 사용하지 않은 경우, 결제수단에 따라 충전일로부터 7일 이내에
								[me캐시충전&gt;충전/사용내역]에서 직접 결제취소 하실 수 있습니다.</li>
							<li>충전일로부터 7일이 경과 한 후 충전취소와 예치금환불은 고객센터로 문의 주시기 바랍니다.</li>
							<li>단, iOS앱에서 충전한 me캐시의 취소는 애플 정책에 따라 애플 고객센터(080-333-4000)를
								통해서만 가능합니다.</li>
							<li>단, Google Play로 충전한 me캐시는 구글 정책에 따라 결제 후 48시간 이내에는
								Google Play 고객센터를 통해, 48시간 이후에는 교보문고 고객센터(</li>
						</ul>
						<ul
...
<script
	src="${cpath}/resources/js/mypage/cash-recharge/cash-recharge-main.js"></script>