...
<link rel="stylesheet"
	href="<c:url value='/resources/css/keepgoing/keepgoing-update.css' />">
<link rel="stylesheet"
	href="<c:url value='/resources/css/keepgoing/keepgoing-var.css' />">
<script src="<c:url value='/resources/js/keepgoing/keepgoing-update.js'/>"></script>
<script src="<c:url value='/resources/js/keepgoing/HuskyEZCreator.js'/>"charset="utf-8"></script>
</head>
<body>
	<section class="container">
		<div class="page-title">킵고잉 수정하기</div>
		<form action="${cpath}/keepgoing/keepgoingupdate.do" method="post"> <!--  막을 예정 -->
						...
						<div class="main-selection">
							...
							<div class="main-selection-border">
								<select id="location" name="location">
									<option value="서울" ${dto.location == '서울' ? 'selected' : ''}>서울</option>
								</select>
							</div>
				...
				<div class="content-line">
					...
					<div id="smarteditor">
						<textarea name="editorTxt" style="width: 100%;" rows="20"
							cols="100" id="editorTxt" placeholder="300자 이내로 입력해주세요.">
                            ${dto.editorTxt} <!-- 데이터 추가 예시-->
                        </textarea>
